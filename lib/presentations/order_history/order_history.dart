...
import 'package:innocence_baby/presentations/order_history/history_details.dart';
    ...
    return GridView.builder(
        ...
        itemBuilder: (context, int index) {
          return GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=> const HistoryDetailView()));
            },
            child: HistoryCard(
